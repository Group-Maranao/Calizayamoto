...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $price = 24999.00; // Assuming the price of Mags is $14999.00
    ...
    if ($quantity > $availableQuantity) {
        ...
        $insertSql = "INSERT INTO products (price, qty, productName, MOP) VALUES ($totalPrice, $quantity, 'Yamaha Mio', '$payment')";
...
<div class="navbar">
    ...
    <div class="col-4">
    <img src="../CRUD/Photo/mioPink.jpg"  alt="Error">
            <div class="col-desc">
                <h4>Yamaha Mio</h4>
                <p>Available Quantity: <span id="currentQuantity"><?php echo $availableQuantity; ?></span></p>
                <p>Price: <span id="currentPrice">24,999.00</span></p> <br>
            </div>
...
<div class="categories">
    <div class="small-container">
        <div class="row">
                <div class="Col-3">
                    <img src="../CRUD/Photo/DisPho1.jpg" alt="Rusi Gala">
                </div>
                <div class="Col-3">
                    <img src="../CRUD/Photo/DisPho3.jpg " alt="Rusi Passion">
                </div>
                <div class="Col-3">
                    <img src="../CRUD/Photo/Dispho2.jpg" alt="Rusi Royal">
                </div>
        </div>
    </div>
</div>
<div class="small-container">
    ...
    <div class="row">
        ...
        <div class="col-4">
            <img src="../CRUD/Photo/rusiPassY.jpg"  alt="Error">
            <h4>Rusi Passion</h4>
            <p>14,999.00php</p> 
            <a href="rusiyellow.php"> <button class = 'btn'>Buy now</button></a>
        </div>
        <div class="col-4">
            <img src="../CRUD/Photo/RoyalRusi.jpg"  alt="Error">
            <h4>Rusi Royal</h4>
            <p>14,999.00php</p> 
        ...
        <div class="col-4">
            <img src="../CRUD/Photo/Mio.jpg" alt="Error">
            <h4>Yamaha Mio</h4>
            <p>24,999.00php</p> 
    ...
    <div class="small-container">
        <div class="row">
            <div class="Col-3">
                ...
                <img src="../CRUD/Photo/Test.jpg" alt="Error">
                <h2>Eric Morales</h2>
            </div>
            <div class="Col-3">
                ...
                <img src="../CRUD/Photo/test1.jpg" alt="Error">
            ...
            <div class="Col-3">
                ...
                <img src="../CRUD/Photo/test2.jpg" alt="Error">
